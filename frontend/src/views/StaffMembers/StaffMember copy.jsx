...
const StaffMember = () => {
  ...
  // useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const filteredUsers = response.data.filter(user => user.type === "3");
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const userToSave = { ...currentUser, type: '3' };
                ...
                <Table>
                  ...
                  <tbody>
                    {users.length > 0 ? (
                      ...
                      <tr>
                        <td colSpan="8" style={{ textAlign: 'center' }}>No Staff member available</td>
                      </tr>
                    )}
                  </tbody>
                </Table>
