...
export const updateProfileWeb = async (req, res) => {
    try {
        const userId = req.params.id;
        const {
            firstName, lastName, email, address, dateOfBirth, country, phone, pincode, state, suburb, type, status,
            ...
            linkedinProfile, notesAndComments, city, termAgreement, attendedBefore, broughtBy, faithLevel, churchId
        } = req.body;
        ...
        const updatedUser = await User.findByIdAndUpdate(
            userId,
            {
                firstName, lastName, email, address, country, phone, pincode, state, suburb, type, status, dateOfBirth,
                gender, jobTitle, department, employmentType, startDate, endDate, workLocation, workEmail,
                userRole, systemAccessLevel, assignedTeams, educationLevel, certifications, skills, languagesSpoken,
                employeeId, salaryOrHourlyRate, payrollBankDetails, tfnAbn, workVisaStatus, emergencyContact,
                linkedinProfile, notesAndComments, city, termAgreement, attendedBefore, broughtBy, faithLevel, churchId,
        ...
        res.status(200).json({
            ...
            user: {
                ...
                broughtBy: updatedUser.broughtBy,
...
//     try {
//         const userId = req.params.id;
//         const { firstName, lastName, email, address, dateOfBirth, country, phone, pincode, state, suburb, type, status } = req.body;
